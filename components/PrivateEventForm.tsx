...
const labelClass =
  "mb-2 block font-mono text-[10px] uppercase tracking-[0.25em] text-haze";
...
export default function PrivateEventForm() {
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("subject", "New Private Event Inquiry — Read the Room");
    ...
    try {
      ...
      if (data.success) {
        setResult("Thanks — we'll be in touch about your event soon.");
        form.reset();
      } else {
